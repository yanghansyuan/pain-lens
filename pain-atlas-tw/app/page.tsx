...
const TERMS:Record<string,string>={
 ...
 'pectoralis major':'胸大肌','pectoralis minor':'胸小肌','pectoralis':'胸肌','sternocostal':'胸肋部','clavicular':'鎖骨部','thorax':'胸廓','rib':'肋骨','sternum':'胸骨',
 'deltoid':'三角肌','supraspinatus':'棘上肌','infraspinatus':'棘下肌','teres minor':'小圓肌','teres major':'大圓肌','subscapularis':'肩胛下肌','rotator cuff':'旋轉肌袖','trapezius':'斜方肌','scapula':'肩胛骨',
 'neck':'頸部','sternocleidomastoid':'胸鎖乳突肌','scalene':'斜角肌','splenius':'夾肌','levator scapulae':'提肩胛肌',
 'quadriceps':'股四頭肌','rectus femoris':'股直肌','vastus lateralis':'股外側肌','vastus medialis':'股內側肌','vastus intermedius':'股中間肌','patella':'髕骨','knee':'膝',
 'ankle':'踝','foot':'足部','plantar':'足底','calcaneus':'跟骨','achilles':'阿基里斯腱','gastrocnemius':'腓腸肌','soleus':'比目魚肌','tibialis anterior':'脛前肌','fibularis':'腓骨肌','peroneus':'腓骨肌',
 'hand':'手部','wrist':'手腕','finger':'手指','thumb':'拇指','palm':'手掌','palmar':'掌側','forearm':'前臂','brachialis':'肱肌','biceps brachii':'肱二頭肌','triceps brachii':'肱三頭肌','flexor':'屈肌','extensor':'伸肌','interossei':'骨間肌','lumbricals':'蚓狀肌',
...
const TIPS:Record<string,{zh:string;keywords:string[]}> = {
 ...
 'pectoralis':{zh:'胸肌',keywords:['pectoral stretch physical therapy','chest muscle pain relief exercises','胸肌 伸展 復健']},
 'pectoralis major':{zh:'胸大肌',keywords:['pectoralis major stretch physical therapy','chest stretch posture physical therapy','胸大肌 伸展']},
 'pectoralis minor':{zh:'胸小肌',keywords:['pectoralis minor stretch physical therapy','pec minor stretch posture','胸小肌 伸展']},
 'deltoid':{zh:'三角肌',keywords:['shoulder pain relief exercises physical therapy','deltoid shoulder rehab exercise','肩膀 三角肌 復健']},
 'supraspinatus':{zh:'棘上肌',keywords:['rotator cuff strengthening physical therapy','supraspinatus rehab exercise','旋轉肌袖 棘上肌 復健']},
 'infraspinatus':{zh:'棘下肌',keywords:['rotator cuff external rotation exercise','infraspinatus rehab exercise','棘下肌 復健']},
 'teres minor':{zh:'小圓肌',keywords:['teres minor rotator cuff exercises','shoulder external rotation rehab','小圓肌 復健']},
 'subscapularis':{zh:'肩胛下肌',keywords:['subscapularis rehab exercises','rotator cuff internal rotation physical therapy','肩胛下肌 復健']},
 'sternocleidomastoid':{zh:'胸鎖乳突肌',keywords:['neck pain relief exercises physical therapy','sternocleidomastoid stretch','頸部 伸展 復健']},
 'scalene':{zh:'斜角肌',keywords:['scalene stretch physical therapy','neck shoulder pain relief exercises','斜角肌 伸展']},
 'levator scapulae':{zh:'提肩胛肌',keywords:['levator scapulae stretch physical therapy','neck shoulder stretch rehab','提肩胛肌 伸展']},
 'quadriceps':{zh:'股四頭肌',keywords:['knee strengthening exercises physical therapy','quadriceps strengthening rehab','股四頭肌 膝蓋 復健']},
 'rectus femoris':{zh:'股直肌',keywords:['quad stretch physical therapy','rectus femoris stretch rehab','股直肌 伸展']},
 'vastus':{zh:'股肌',keywords:['quadriceps strengthening physical therapy','knee pain strengthening exercises','股四頭肌 強化']},
 'gastrocnemius':{zh:'腓腸肌',keywords:['calf stretch physical therapy','gastrocnemius stretch ankle pain','小腿 腓腸肌 伸展']},
 'soleus':{zh:'比目魚肌',keywords:['soleus stretch physical therapy','ankle mobility calf stretch','比目魚肌 伸展']},
 'tibialis anterior':{zh:'脛前肌',keywords:['ankle strengthening exercises physical therapy','tibialis anterior strengthening rehab','脛前肌 踝關節 復健']},
 'plantar':{zh:'足底',keywords:['plantar fasciitis stretches physical therapy','foot pain relief exercises','足底筋膜 伸展']},
};
const SEARCH_ALIASES:Record<string,string[]>={
 ...
 '胸':['pectoralis','pectoralis major','pectoralis minor'],'胸肌':['pectoralis','pectoralis major','pectoralis minor'],'胸大肌':['pectoralis major'],'胸小肌':['pectoralis minor'],
 '肩':['deltoid','supraspinatus','infraspinatus','teres minor','subscapularis','trapezius'],'三角肌':['deltoid'],'旋轉肌袖':['supraspinatus','infraspinatus','teres minor','subscapularis'],
 '頸':['sternocleidomastoid','scalene','levator scapulae','splenius'],'脖子':['sternocleidomastoid','scalene','levator scapulae','splenius'],
 '膝':['knee','patella','quadriceps','vastus','rectus femoris'],'膝蓋':['knee','patella','quadriceps','vastus','rectus femoris'],'股四頭肌':['quadriceps','vastus','rectus femoris'],
 '腳踝':['ankle','tibialis anterior','gastrocnemius','soleus','fibularis'],'足底':['plantar','foot'],'小腿':['gastrocnemius','soleus','tibialis anterior'],
...
const VIDEO_PREVIEWS=[
 {match:['pectoralis','胸肌','胸大肌','胸小肌','sternocostal','chest','thorax','rib','sternum'],title:'胸肌伸展與胸廓打開示範',id:'NePr1XKRTLU',caption:'適合先理解胸大肌、胸小肌緊繃時常見的開胸伸展方向。'},
 {match:['deltoid','三角肌','shoulder','肩','supraspinatus','infraspinatus','teres minor','teres major','subscapularis','rotator cuff','scapula','trapezius'],title:'肩膀疼痛常見復健動作示範',id:'43eAKuyAIp8',caption:'涵蓋肩胛穩定、旋轉肌袖與肩周邊肌群的基礎動作方向。'},
 {match:['neck','頸','脖子','cervical','sternocleidomastoid','scalene','splenius','levator scapulae'],title:'頸部疼痛 5 分鐘即時練習',id:'Ptu00HuwPXw',caption:'適合先理解頸部與肩頸周邊肌群的溫和活動與等長訓練。'},
 {match:['knee','膝','膝蓋','patella','quadriceps','rectus femoris','vastus','股四頭肌'],title:'膝蓋僵硬與疼痛常見練習',id:'Bua5poSCqFI',caption:'用來理解膝周邊肌群啟動、活動度與站姿訓練的基本方向。'},
 {match:['ankle','腳踝','foot','足部','plantar','足底','calcaneus','achilles','gastrocnemius','soleus','tibialis anterior','fibularis','peroneus'],title:'腳踝/足部疼痛 5 分鐘練習',id:'5TpWXh8U7MQ',caption:'涵蓋踝泵、踝圈、提踵與平衡訓練，適合先看足踝動作方向。'},
 {match:['hand','手部','wrist','手腕','finger','手指','thumb','拇指','palm','palmar','掌側','interossei','lumbricals','forearm'],title:'手部/手腕伸展與訓練示範',id:'mlh5ExWWkVo',caption:'適合用來先理解手腕、手指與前臂肌群的復健動作方向。'},
...
const REGION_PREVIEWS=[
 {match:['adductor','gracilis','sartorius','pectineus','obturator','gemellus','plantaris','popliteus','hallucis','digitorum longus','thigh','leg','femur'],video:VIDEO_PREVIEWS[3],region:'下肢/膝髖通用'},
 {match:['pollicis','carpi','pronator','brachioradialis','anconeus','coracobrachialis','humerus','ulna','radius'],video:VIDEO_PREVIEWS[5],region:'手腕/前臂通用'},
 {match:['intercostal','serratus','subclavius','transversus thoracis','costarum','clavicular','abdominal part'],video:VIDEO_PREVIEWS[0],region:'胸廓/胸肌通用'},
 {match:['coccygeus','pubococcygeus','puborectalis','iliococcygeus','perineal','sphincter'],video:VIDEO_PREVIEWS[7],region:'骨盆/髖部通用'},
 {match:['oblique','transversus abdominis','rectus abdominis','abdomen','abdominal'],video:VIDEO_PREVIEWS[8],region:'軀幹/下背通用'},
 {match:['eye','palpebrae','rectus','oblique'],video:VIDEO_PREVIEWS[2],region:'頭頸通用'}
];
type VideoPreview=typeof VIDEO_PREVIEWS[number]&{fallbackRegion?:string};
...
function videoPreviews(name:string):VideoPreview[]{
 ...
 const fallback=REGION_PREVIEWS.find(v=>v.match.some(term=>text.includes(term.toLowerCase())));
 return fallback?[{...fallback.video,fallbackRegion:fallback.region}]:[];
}
...
export default function Home(){
 ...
 const [atlas,setAtlas]=useState<Atlas|null>(null),[state,setState]=useState(initial),[progress,setProgress]=useState(0),[error,setError]=useState(''),[panel,setPanel]=useState<'layers'|'search'|null>(null),[details,setDetails]=useState(false),[about,setAbout]=useState(false),[query,setQuery]=useState(''),[chosen,setChosen]=useState<Concept|null>(null),[largeVideo,setLargeVideo]=useState<VideoPreview|null>(null);
 ...
 return <main className="studio">
  ...
  <header className="identity"><div className="eyebrow"><span className="status-dot"/> 互動式解剖模型</div><h1 className="brand-title"><span>Pain Lens</span><Badge variant="outline" className="edition">疼痛透視鏡</Badge></h1><div className="identity-meta">{atlas?atlas.parts.length.toLocaleString():'2,234'} 個可選部位 <span>·</span> BodyParts3D</div></header>
